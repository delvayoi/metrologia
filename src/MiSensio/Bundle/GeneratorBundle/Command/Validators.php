...
class Validators
{
    ...
    public static function getReservedWords()
    {
     ...
     public static function validateNonbreProyect($nonbreProyect)
    {
        if ($nonbreProyect == '') {
            throw new \InvalidArgumentException(sprintf('Introdusca el nombre del proyecto'));
        }

        return $nonbreProyect;
    }
    
    
     public static function validateCampo($campo)
    {
        if ($campo == '') {
            throw new \InvalidArgumentException(sprintf('Introdusca el nombre del campo'));
        }
